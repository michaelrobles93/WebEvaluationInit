...
<t:pageTemplate title="Usuários Cadastradas - Web Evaluation">

	<div class="row">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>Usuários Cadastradas</h5>
...
<script>
	$(document).ready(function() {
		...
		var msgSucesso = "Os dados do usuario foram atualizados!";
		var msgErro = "Houve um erro ao atualizar os dados do usuário!";
	...
	document.getElementById("listUsuario").setAttribute("class", "active");
</script>
