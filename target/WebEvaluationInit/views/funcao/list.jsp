...
<t:pageTemplate title="Funções Cadastradas - Web Evaluation">
...
<script>
	$(document).ready(function() {
		...
		var msgSucesso = "Os dados da função de cargos foram atualizados!";
		var msgErro = "Houve um erro ao atualizar os dados da função de cargos!";
	...
	document.getElementById("listFuncao").setAttribute("class", "active");
</script>
