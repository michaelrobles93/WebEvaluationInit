...
<t:pageTemplate title="Cadastrar Funções - Web Evaluation">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<form:form action="${s:mvcUrl('FC#novo').build()}.html"
						commandName="funcao" role="form">
					<div class="ibox-title">
						<h5>Cadastro de Funções</h5>
					</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label>Descrição</label> <form:input path="descricao" cssClass="form-control"
...
<script>
	...
	$(document).ready(function() {
		var msgSucesso = "Os dados da função de cargos foram cadastrados!";
		var msgErro = "Houve um erro ao cadastrar os dados da função de cargos!";
	...
	document.getElementById("formFuncao").setAttribute("class", "active");
</script>